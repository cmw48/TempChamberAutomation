...
//backplane
module thermotron(){
translate([-45, -30, 19]) color([.71,.65,.65]) cube([150,150,1.5]);
...
module platebottom() {
    difference(){
      translate([-30, -30, 5]) cube([115,150,1.5]);
...
module platemiddle() {
  difference() {
    translate([-30, -30, -11]) cube([115,150
     ,1.5]);
...
//added -10
module platetop() {
    translate([-30, -30, -15]) cube([115,150,1.5]);
}

//added to hold servos and guide coupler
module platetiptop() {
    translate([-30, -30, -33]) cube([115,150,1.5]);
}
...
module platesubtract() {
    union() {
        renderservos();
        translate([40, 46, -15]) color([.8,.65,.65]) cube([35, 11, 30]);
        translate([-13, 97, -15]) color([.8,.65,.65]) cube([25, 10, 30]);    
        // screwholes
